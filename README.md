...
| GitHub Copilot Coding Agent (GPT-5-class) | Upgraded accessibility engine dependencies (`@axe-core/playwright`, `accessibility-checker`, `@accesslint/core`) and re-verified curated rule metadata mappings | Development – September 2026 |
