...
- **9 branches** have been fully merged into main with 0 unique commits remaining
- **1 branch** (copilot/fix-puppeteer-connection-error) contains only an empty "Initial plan" commit with no actual work
...
Expected output: All branches show "0 unique commits" (except copilot/fix-puppeteer-connection-error with 1 empty commit)
